...
(function ($) {
  ...
  Selectpicker.prototype = {
    ...
    createDropdown: function () {
      ...
      '<button type="button" class="actions-btn bs-select-all btn-select">' +
      this.options.selectAllText +
      '</button>' +
      '<button type="button" class="actions-btn bs-deselect-all btn-select">' +
      ...
      '<button type="button" class=" btn-sm btn-select">' +
